  ...
  <div class="phoneApprove">
    ...
    <div class="modal" v-if="showModal">
      <div class="textContent">
        ...
        <p>【审慎阅读】您在申请注册流程中点击同意本协议之前，应当认真阅读本协议。请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制责任的条款、授权条款、法律适用和争议解决条款。免除或者限制责任的条款、授权条款将以粗体标识，您应重点阅读。如您对本协议有任何疑问，可向掌金超平台的客服咨询。</p>
        <p>【签约动作】当您按照注册页面提示填写信息、阅读并同意本协议且完成全部注册程序后，即表示您已充分阅读、理解并接受本协议的全部内容，并与掌金超平台达成一致，成为掌金超平台的注册用户。阅读本协议的过程中，如果您不同意本协议或其中任何条款约定，您应立即停止注册程序。</p>
        <p>【协议修改】在本协议履行过程中，掌金超平台可根据实际情况对协议的相关条款进行修改。掌金超平台将通过掌金超公众号公布最新的协议，已签约的用户无需再次签约。如用户不同意掌金超平台对本协议所做的修改，应停止使用掌金超平台通过掌金超公众号提供的服务；如用户继续使用服务或未主动终止服务，则视为同意履行修改后的协议，并应依照修改后的协议履行应尽义务。</p>
        <p>第一章 掌金超平台使用限制说明</p>
        <p>第1条：</p>
        ...
        <p>第3条：</p>
        <p>用户有义务确保其信息的真实性、准确性、完整性和有效性，并承诺对其提供的信息及时进行更新。若掌金超平台经判断有合理理由认定用户信息存在错误、虚假、过时情形的，掌金超平台有权终止用户在掌金超平台的账户；由此给用户造成损失的，掌金超平台不承担任何责任。</p>
        <p>第4条：</p>
        <p>用户有义务提供有效的联系方式，包括但不限于手机号码、电话号码、通讯地址、常用电子邮箱、联系人信息等。联系方式发生变更时，应在3日内联系掌金超客服说明情况。因用户未提供有效联系方式，导致掌金超平台未能提供相应服务或给用户造成损失的，由用户自行承担全部损失和不利法律后果。</p>
        <p>第二章 掌金超平台服务内容说明</p>
        <p>第5条：</p>
        <p>掌金超平台通过掌金超平台为用户提供的服务包括但不限于：信息搜集、信息公布、甄别筛选、资信评估、信息交互、借贷撮合、融资咨询等相关服务。部分服务需要用户完成身份认证才能享用。用户因未完成身份认证而无法享受服务的，掌金超平台不承担任何责任。</p>
        <p>第6条：</p>
        ...
        <p>第8条：</p>
        <p>掌金超平台采取适当的方法和技术，记录并妥善保存网络借贷业务活动数据和资料。用户绑定的手机号为掌金超平台向用户发送短信/公众号推送消息的接收手机/微信号。用户承诺，注册成功后会密切关注注册手机号/微信号。任何信息从掌金超平台发出起，即视为已告知用户，并且用户已知悉。</p>
        <p>第9条：</p>
        ...
        <p>第11条：</p>
        <p>为了改善用户体验，掌金超平台会根据需要对掌金超平台的产品及服务的各功能使用情况进行统计，这些统计一般为应用使用时间、页面停留时间、访问次数，访问路径等，并且会对应用报错数据进行收集。通过分析统计数据可以帮助我们提高产品质量及服务质量。</p>
        <p>第三章 用户信息收集、使用和提供</p>
        <p>第12条：</p>
        <p>为促进网络借贷活动的合法顺利开展、便于掌金超平台对用户进行必要审核和提供相关服务，用户需要向掌金超平台提供包括但不限于姓名、身份证号码、手机号码、年龄、性别、职业、出生日期、户籍、通讯地址、教育情况、收入情况、婚姻家庭情况、通话情况、工作信息、收入信息、信用信息、信用卡信息、社保缴纳信息、公积金缴纳信息、银行流水信息、电商信息、保单信息等信息，且用户同意掌金超平台对前述信息进行处理分析。</p>
        <p>第13条：</p>
        ...
        <p>第16条：</p>
        <p>掌金超平台可能会与第三方合作向用户提供相应的服务，在此情况下，如该第三方同意承担与本平台同等的保护用户信息的责任，则用户同意掌金超平台将用户的相应信息提供给该第三方，并同意该第三方与其进行联系；用户同意掌金超平台及第三方向其引介掌金超平台及其他主体的产品及服务。</p>
        <p>第17条：</p>
        ...
        <p>第21条：</p>
        <p>根据法律规定及合理商业习惯，在掌金超平台计划与其他公司合并或被其收购或进行其他资本市场活动（包括但不限于IPO，债券发行）时，以及其他情形下，掌金超平台需要接受来自其他主体的尽职调查时，用户同意掌金超平台把用户的信息提供给必要的主体，但我们会通过和这些主体签署保密协议等方式要求其对用户信息采取合理的保密措施。</p>
        <p>第22条：</p>
        ...
        <p>第30条：</p>
        <p>为了对用户进行身份核验，保障用户登录安全，掌金超平台会记录用户使用设备的基础信息，包括国际移动设备标识、网络设备的物理地址、设备序列号、设备名称、设备品牌、设备机型、操作系统等。并且会记录用户地理位置信息、WIFI信息、基站信息等。这些信息将用于对用户唯一性的识别，防止恶意登录，保障用户账户安全。</p>
        <p>第31条：</p>
        ...
        <p>第41条：</p>
        <p>掌金超平台制定了严格的用户信息处理规则和采取必要技术措施保护用户的信息安全，确保用户信息不被滥用。除征得用户明确同意和法律法规另有规定或国家司法、行政机关、行业协会、相应监管机构要求，本平台不会向任何第三方提供或对外披露用户信息。</p>
        <p>第十一章 知识产权保护说明</p>
        <p>第42条：</p>
        <p>掌金超平台上所有内容的知识产权均由掌金超平台及其权利人依法拥有，包括但不限于文本、数据、文章、图片、资讯、平台架构、网页设计等。未经掌金超平台或其权利人书面同意，任何人不得擅自使用、修改、复制、公开发布相关内容；如有违反，用户应对掌金超平台及其权利人承担损害赔偿等法律责任。</p>
        <p>第十二章 法律适用说明</p>
        <p>第43条：</p>
        ...
        <p>第45条：</p>
        <p>本协议签订地为中华人民共和国北京市。因本协议所引起的用户与掌金超平台的任何纠纷及争议，各方一致同意，不论争议金额大小，均提交北京仲裁委员会适用北京仲裁委员会仲裁规则项下的简易程序进行仲裁。仲裁裁决为终局裁决，对双方均具有约束力。</p>
      </div>
      <div class="btnBox">
